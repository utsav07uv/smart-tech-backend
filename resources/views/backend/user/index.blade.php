    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-end my-2">
                <x-link :href="route('admin.user.create')">Create</x-link>
            </div>
                    ...
                    <table id="user-table">
                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr>
                                    <td>
                                        <img class="w-10 h-10 rounded-sm" src="{{ $user->avatar }}" alt="{{ $user->name }}">
                                    </td>
                                    <td>{{ $user->name }}</td>
                                    <td>{{ $user->role->label() }}</td>
                                    <td>
                                        <span
                                            class="{{ $user->isApproved() ? "bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300" : "bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-300"}} text-xs font-medium me-2 px-2.5 py-0.5 rounded-full">{{ $user->isApproved() ? "Enabled" : "Disabled" }}</span>
                                    </td>
                                    <td>
