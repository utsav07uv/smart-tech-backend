    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-end my-2">
                <x-link :href="route('stock.create')">Add</x-link>
            </div>
                    ...
                    <table id="category-table">
                        ...
                        <tbody>
                            @foreach ($stocks as $stock)
                                <tr class="{{ $stock->type->color() }}">
                                    <td>{{ $stock->product?->name }}</td>
                                    <td>{{ $stock->quantity }}</td>
                                    <td>{{ $stock->type->label() }}</td>
                                    <td>{{ $stock->reference }}</td>
                                    <td>{{ $stock->note }}</td>
                                    <td>
                                        <p class="mb-0">{{ $stock->recordedBy->name }}</p>
                                        <p>({{ $stock->recordedBy->role->label() }})</p>
                                    </td>
                                    <td>
                                                    ...
                                                    <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                                        ...
                                                        <div class="p-4 md:p-5 text-center">
                                                            ...
                                                            <h3
                                                                ...
                                                                Are you sure you want to delete this stock?</h3>
