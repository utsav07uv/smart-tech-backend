                        ...
                        <ul class="ul">
                            ...
                            <li class="productlink-li">
                                ...
                                <ul class="productsupmenu-dropdown collapse" id="vega-sub2">
                                    <li class="productsupmenu-li">
                                        <a href="product-details.php" class="productsuplink-title">
                ...
                <ul class="main-menu">
                        ...
                        <div class="menu-dropdown menu-banner collapse" id="menu-shop-banner">
                            <ul class="container ul p-0">
                                <li class="menubanner-li">
                                    <div class="menubanner-img">
                                        <a href="collection.html" class="collection-img banner-hover">
                                            <img src="img/menu/home1-menu-banner1.jpg" class="img-fluid"
                                                alt="menu-banner1">
                                        </a>
                                ...
                                <li class="menubanner-li">
                                    <div class="menubanner-img">
                                        <a href="collection.html" class="collection-img banner-hover">
                                            <img src="img/menu/home1-menu-banner2.jpg" class="img-fluid"
                                                alt="menu-banner2">
                                        </a>
                                        <a href="collection.html" class="collection-title">
                                ...
                                <li class="menubanner-li">
                                    <div class="menubanner-img">
                                        <a href="collection.html" class="collection-img banner-hover">
                                            <img src="img/menu/home1-menu-banner3.jpg" class="img-fluid"
                                                alt="menu-banner3">
                                        </a>
                                        <a href="collection.html" class="collection-title">
                                ...
                                <li class="menubanner-li">
                                    <div class="menubanner-img">
                                        <a href="collection.html" class="collection-img banner-hover">
                                            <img src="img/menu/home1-menu-banner4.jpg" class="img-fluid"
                                                alt="menu-banner4">
                                        </a>
                                        <a href="collection.html" class="collection-title">
                        ...
                        <div class="menu-dropdown menu-mega collapse" id="menu-mega">
                            <ul class="ul container p-0">
                                <li class="menumega-li">
                                    <a href="#menumega-sup1" class="menumega-title" data-bs-toggle="collapse"
                                        aria-expanded="false">
                                ...
                                <li class="menumega-li">
                                    <a href="#menumega-sup2" class="menumega-title" data-bs-toggle="collapse"
                                        aria-expanded="false">
                                    ...
                                    <div class="menumegasup-dropdown collapse" id="menumega-sup2">
                                        <ul class="menumegasup-ul">
                                            <li class="menumegasup-li">
                                                <a href="product-details.php" class="menumegasup-title">
                                                    <span class="sp-link-title">Product layout</span>
                                                </a>
                                            </li>
                                            <li class="menumegasup-li">
                                ...
                                <li class="menumega-li">
                                    <div class="menu-product">
                                                ...
                                                <div class="product-menu-list">
                                                    <div class="single-product-wrap">
                                                        <div class="product-image">
                                                            <a href="product-details.php" class="pro-img">
                                                                <img class="img-fluid img1"
                                                                    src="img/menu/home-pro-banner1.jpg" alt="menupro-1">
                                                                <img class="img-fluid img2"
                                                                    src="img/menu/home-pro-banner2.jpg" alt="menupro-2">
                                                            </a>
                                                        </div>
                                                        <div class="product-content">
                                                            <h6><a href="product-details.php">Portable speaker</a></h6>
                                                            <div class="price-box">
                                                ...
                                                <div class="product-menu-list">
                                                    <div class="single-product-wrap">
                                                        <div class="product-image">
                                                            <a href="product-details.php" class="pro-img">
                                                                <img class="img-fluid img1"
                                                                    src="img/menu/home-pro-banner3.jpg" alt="menupro-3">
                                                                <img class="img-fluid img2"
                                                                    src="img/menu/home-pro-banner4.jpg" alt="menupro-4">
                                                            </a>
                                                        </div>
                                                        <div class="product-content">
                                                            <h6><a href="product-details.php">Bluetooth</a></h6>
                                                            <div class="price-box">
                                        ...
                                        <div class="menu-product-btn">
                                            <a href="collection.html" class="menu-pro-link">See more<i
                                                ...
                                                <div class="product-menu-list">
                                                    <div class="single-product-wrap">
                                                        <div class="product-image">
                                                            <a href="product-details.php" class="pro-img">
                                                                <img class="img-fluid img1"
                                                                    src="img/menu/home-pro-banner5.jpg" alt="menupro-1">
                                                                <img class="img-fluid img2"
                                                                    src="img/menu/home-pro-banner6.jpg" alt="menupro-2">
                                                            </a>
                                                        </div>
                                                        <div class="product-content">
                                                            <h6><a href="product-details.php">Headphones</a></h6>
                                                            <div class="price-box">
                                                ...
                                                <div class="product-menu-list">
                                                    <div class="single-product-wrap">
                                                        <div class="product-image">
                                                            <a href="product-details.php" class="pro-img">
                                                                <img class="img-fluid img1"
                                                                    src="img/menu/home-pro-banner7.jpg" alt="menupro-3">
                                                                <img class="img-fluid img2"
                                                                    src="img/menu/home-pro-banner8.jpg" alt="menupro-4">
                                                            </a>
                                                        </div>
                                                        <div class="product-content">
                                                            <h6><a href="product-details.php">Shoot drone</a></h6>
                                                            <div class="price-box">
                    ...
                    <li class="menu-link">
                        ...
                        <div class="menu-dropdown menu-single collapse" id="menu-blog">
                            <ul class="ul">
                                ...
                                <li class="menusingle-li">
                                    <a href="blog.php" class="menusingle-title">
                    ...
                    <li class="menu-link">
                        ...
                        <div class="menu-dropdown menu-sub collapse" id="menu-sub">
                            <ul class="ul">
                                <li class="menusub-li">
                                    <a href="#menu-sup" class="menusub-title" data-bs-toggle="collapse"
                                        aria-expanded="false">
                                ...
                                <li class="menusub-li">
                                    <a href="#account" class="menusub-title" data-bs-toggle="collapse"
                                        aria-expanded="false">
                                    ...
                                    <div class="menusup-dropdown collapse" id="account">
                                        <ul class="menusup-ul">
                                            ...
                                            <li class="menusup-li">
                                                <a href="{{ route('frontend.address') }}" class="menusup-title">
                                ...
                                <li class="menusub-li">
                                    <a href="#desk-checkout" class="menusub-title" data-bs-toggle="collapse"
                                        aria-expanded="false">
